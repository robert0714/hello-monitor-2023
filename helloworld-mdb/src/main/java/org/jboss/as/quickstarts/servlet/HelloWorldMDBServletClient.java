...
import org.jboss.as.quickstarts.common.JMS11Sender;
...
public class HelloWorldMDBServletClient extends HttpServlet {
    ...
    private JMS11Sender jms11Sender;
    @PostConstruct
    ...
    protected void sendMsgByJMS11(final String text) {
    	jms11Sender.sendMsgByJMS11(cf,queue, s -> jms11Sender.createTextMessage(s, text));
	}
